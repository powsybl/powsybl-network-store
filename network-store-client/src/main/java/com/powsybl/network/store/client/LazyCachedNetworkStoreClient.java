...
public class LazyCachedNetworkStoreClient implements NetworkStoreClient {
    ...
    public List<Resource<SubstationAttributes>> getSubstations(UUID networkUuid) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getAllResources(ResourceType.SUBSTATION, () -> bufferedRestNetworkStoreClient.getSubstations(networkUuid));
    }

    @Override
    public Optional<Resource<SubstationAttributes>> getSubstation(UUID networkUuid, String substationId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResource(ResourceType.SUBSTATION, substationId, id ->  bufferedRestNetworkStoreClient.getSubstation(networkUuid, id));
    }
    ...
    public Optional<Resource<VoltageLevelAttributes>> getVoltageLevel(UUID networkUuid, String voltageLevelId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResource(ResourceType.VOLTAGE_LEVEL, voltageLevelId, id ->  bufferedRestNetworkStoreClient.getVoltageLevel(networkUuid, id));
    }

    @Override
    public List<Resource<VoltageLevelAttributes>> getVoltageLevels(UUID networkUuid) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getAllResources(ResourceType.VOLTAGE_LEVEL, () -> bufferedRestNetworkStoreClient.getVoltageLevels(networkUuid));    }
    ...
    public List<Resource<BusbarSectionAttributes>> getVoltageLevelBusbarSections(UUID networkUuid, String voltageLevelId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResourcesByVoltageId(ResourceType.BUSBAR_SECTION, voltageLevelId, id -> bufferedRestNetworkStoreClient.getVoltageLevelBusbarSections(networkUuid, id));
    }

    @Override
    public List<Resource<SwitchAttributes>> getVoltageLevelSwitches(UUID networkUuid, String voltageLevelId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResourcesByVoltageId(ResourceType.SWITCH, voltageLevelId, id -> bufferedRestNetworkStoreClient.getVoltageLevelSwitches(networkUuid, id));
    }

    @Override
    public List<Resource<GeneratorAttributes>> getVoltageLevelGenerators(UUID networkUuid, String voltageLevelId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResourcesByVoltageId(ResourceType.GENERATOR, voltageLevelId, id -> bufferedRestNetworkStoreClient.getVoltageLevelGenerators(networkUuid, id));
    }

    @Override
    public List<Resource<LoadAttributes>> getVoltageLevelLoads(UUID networkUuid, String voltageLevelId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResourcesByVoltageId(ResourceType.LOAD, voltageLevelId, id -> bufferedRestNetworkStoreClient.getVoltageLevelLoads(networkUuid, id));
    }

    @Override
    public List<Resource<ShuntCompensatorAttributes>> getVoltageLevelShuntCompensators(UUID networkUuid, String voltageLevelId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResourcesByVoltageId(ResourceType.SHUNT_COMPENSATOR, voltageLevelId, id -> bufferedRestNetworkStoreClient.getVoltageLevelShuntCompensators(networkUuid, id));
    }
    ...
    public List<Resource<StaticVarCompensatorAttributes>> getVoltageLevelStaticVarCompensators(UUID networkUuid, String voltageLevelId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResourcesByVoltageId(ResourceType.STATIC_VAR_COMPENSATOR, voltageLevelId, id -> bufferedRestNetworkStoreClient.getVoltageLevelStaticVarCompensators(networkUuid, id));
    }
    ...
    public List<Resource<VscConverterStationAttributes>> getVoltageLevelVscConverterStation(UUID networkUuid, String voltageLevelId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResourcesByVoltageId(ResourceType.VSC_CONVERTER_STATION, voltageLevelId, id -> bufferedRestNetworkStoreClient.getVoltageLevelVscConverterStation(networkUuid, id));
    }
    ...
    public List<Resource<LccConverterStationAttributes>> getVoltageLevelLccConverterStation(UUID networkUuid, String voltageLevelId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResourcesByVoltageId(ResourceType.LCC_CONVERTER_STATION, voltageLevelId, id -> bufferedRestNetworkStoreClient.getVoltageLevelLccConverterStation(networkUuid, id));
    }
    ...
    public List<Resource<TwoWindingsTransformerAttributes>> getVoltageLevelTwoWindingsTransformers(UUID networkUuid, String voltageLevelId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResourcesByVoltageId(ResourceType.TWO_WINDINGS_TRANSFORMER, voltageLevelId, id -> bufferedRestNetworkStoreClient.getVoltageLevelTwoWindingsTransformers(networkUuid, id));
    }
    ...
    public List<Resource<ThreeWindingsTransformerAttributes>> getVoltageLevelThreeWindingsTransformers(UUID networkUuid, String voltageLevelId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResourcesByVoltageId(ResourceType.THREE_WINDINGS_TRANSFORMER, voltageLevelId, id -> bufferedRestNetworkStoreClient.getVoltageLevelThreeWindingsTransformers(networkUuid, id));
    }

    @Override
    public List<Resource<LineAttributes>> getVoltageLevelLines(UUID networkUuid, String voltageLevelId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResourcesByVoltageId(ResourceType.LINE, voltageLevelId, id -> bufferedRestNetworkStoreClient.getVoltageLevelLines(networkUuid, id));
    }

    @Override
    public List<Resource<DanglingLineAttributes>> getVoltageLevelDanglingLines(UUID networkUuid, String voltageLevelId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResourcesByVoltageId(ResourceType.DANGLING_LINE, voltageLevelId, id -> bufferedRestNetworkStoreClient.getVoltageLevelDanglingLines(networkUuid, id));
    }
    ...
    public List<Resource<SwitchAttributes>> getSwitches(UUID networkUuid) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getAllResources(ResourceType.SWITCH, () -> bufferedRestNetworkStoreClient.getSwitches(networkUuid));
    }

    @Override
    public Optional<Resource<SwitchAttributes>> getSwitch(UUID networkUuid, String switchId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResource(ResourceType.SWITCH, switchId, id ->  bufferedRestNetworkStoreClient.getSwitch(networkUuid, id));
    }
    ...
    public List<Resource<BusbarSectionAttributes>> getBusbarSections(UUID networkUuid) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getAllResources(ResourceType.BUSBAR_SECTION, () -> bufferedRestNetworkStoreClient.getBusbarSections(networkUuid));
    }

    @Override
    public Optional<Resource<BusbarSectionAttributes>> getBusbarSection(UUID networkUuid, String busbarSectionId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResource(ResourceType.BUSBAR_SECTION, busbarSectionId, id ->  bufferedRestNetworkStoreClient.getBusbarSection(networkUuid, id));
    }
    ...
    public List<Resource<LoadAttributes>> getLoads(UUID networkUuid) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getAllResources(ResourceType.LOAD, () -> bufferedRestNetworkStoreClient.getLoads(networkUuid));
    }

    @Override
    public Optional<Resource<LoadAttributes>> getLoad(UUID networkUuid, String loadId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResource(ResourceType.LOAD, loadId, id ->  bufferedRestNetworkStoreClient.getLoad(networkUuid, id));
    }
    ...
    public List<Resource<GeneratorAttributes>> getGenerators(UUID networkUuid) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getAllResources(ResourceType.GENERATOR, () -> bufferedRestNetworkStoreClient.getGenerators(networkUuid));
    }

    @Override
    public Optional<Resource<GeneratorAttributes>> getGenerator(UUID networkUuid, String generatorId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResource(ResourceType.GENERATOR, generatorId, id ->  bufferedRestNetworkStoreClient.getGenerator(networkUuid, id));
    }
    ...
    public List<Resource<TwoWindingsTransformerAttributes>> getTwoWindingsTransformers(UUID networkUuid) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getAllResources(ResourceType.TWO_WINDINGS_TRANSFORMER, () -> bufferedRestNetworkStoreClient.getTwoWindingsTransformers(networkUuid));
    }
    ...
    public Optional<Resource<TwoWindingsTransformerAttributes>> getTwoWindingsTransformer(UUID networkUuid, String twoWindingsTransformerId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResource(ResourceType.TWO_WINDINGS_TRANSFORMER, twoWindingsTransformerId, id ->  bufferedRestNetworkStoreClient.getTwoWindingsTransformer(networkUuid, id));
    }
    ...
    public List<Resource<ThreeWindingsTransformerAttributes>> getThreeWindingsTransformers(UUID networkUuid) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getAllResources(ResourceType.THREE_WINDINGS_TRANSFORMER, () -> bufferedRestNetworkStoreClient.getThreeWindingsTransformers(networkUuid));
    }
    ...
    public Optional<Resource<ThreeWindingsTransformerAttributes>> getThreeWindingsTransformer(UUID networkUuid, String threeWindingsTransformerId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResource(ResourceType.THREE_WINDINGS_TRANSFORMER, threeWindingsTransformerId, id ->  bufferedRestNetworkStoreClient.getThreeWindingsTransformer(networkUuid, id));
    }
    ...
    public List<Resource<LineAttributes>> getLines(UUID networkUuid) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getAllResources(ResourceType.LINE, () -> bufferedRestNetworkStoreClient.getLines(networkUuid));
    }

    @Override
    public Optional<Resource<LineAttributes>> getLine(UUID networkUuid, String lineId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResource(ResourceType.LINE, lineId, id ->  bufferedRestNetworkStoreClient.getLine(networkUuid, id));
    }
    ...
    public List<Resource<ShuntCompensatorAttributes>> getShuntCompensators(UUID networkUuid) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getAllResources(ResourceType.SHUNT_COMPENSATOR, () -> bufferedRestNetworkStoreClient.getShuntCompensators(networkUuid));
    }

    @Override
    public Optional<Resource<ShuntCompensatorAttributes>> getShuntCompensator(UUID networkUuid, String shuntCompensatorId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResource(ResourceType.SHUNT_COMPENSATOR, shuntCompensatorId, id ->  bufferedRestNetworkStoreClient.getShuntCompensator(networkUuid, id));
    }
    ...
    public List<Resource<VscConverterStationAttributes>> getVscConverterStations(UUID networkUuid) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getAllResources(ResourceType.VSC_CONVERTER_STATION, () -> bufferedRestNetworkStoreClient.getVscConverterStations(networkUuid));
    }
    ...
    public Optional<Resource<VscConverterStationAttributes>> getVscConverterStation(UUID networkUuid, String vscConverterStationId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResource(ResourceType.VSC_CONVERTER_STATION, vscConverterStationId, id ->  bufferedRestNetworkStoreClient.getVscConverterStation(networkUuid, id));
    }
    ...
    public List<Resource<LccConverterStationAttributes>> getLccConverterStations(UUID networkUuid) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getAllResources(ResourceType.LCC_CONVERTER_STATION, () -> bufferedRestNetworkStoreClient.getLccConverterStations(networkUuid));
    }
    ...
    public Optional<Resource<LccConverterStationAttributes>> getLccConverterStation(UUID networkUuid, String lccConverterStationId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResource(ResourceType.LCC_CONVERTER_STATION, lccConverterStationId, id ->  bufferedRestNetworkStoreClient.getLccConverterStation(networkUuid, id));
    }
    ...
    public List<Resource<StaticVarCompensatorAttributes>> getStaticVarCompensators(UUID networkUuid) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getAllResources(ResourceType.STATIC_VAR_COMPENSATOR, () -> bufferedRestNetworkStoreClient.getStaticVarCompensators(networkUuid));
    }
    ...
    public Optional<Resource<StaticVarCompensatorAttributes>> getStaticVarCompensator(UUID networkUuid, String staticVarCompensatorId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResource(ResourceType.STATIC_VAR_COMPENSATOR, staticVarCompensatorId, id ->  bufferedRestNetworkStoreClient.getStaticVarCompensator(networkUuid, id));
    }
    ...
    public List<Resource<HvdcLineAttributes>> getHvdcLines(UUID networkUuid) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getAllResources(ResourceType.HVDC_LINE, () -> bufferedRestNetworkStoreClient.getHvdcLines(networkUuid));
    }

    @Override
    public Optional<Resource<HvdcLineAttributes>> getHvdcLine(UUID networkUuid, String hvdcLineId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResource(ResourceType.HVDC_LINE, hvdcLineId, id ->  bufferedRestNetworkStoreClient.getHvdcLine(networkUuid, id));
    }
    ...
    public List<Resource<DanglingLineAttributes>> getDanglingLines(UUID networkUuid) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getAllResources(ResourceType.DANGLING_LINE, () -> bufferedRestNetworkStoreClient.getDanglingLines(networkUuid));
    }

    @Override
    public Optional<Resource<DanglingLineAttributes>> getDanglingLine(UUID networkUuid, String danglingLineId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResource(ResourceType.DANGLING_LINE, danglingLineId, id ->  bufferedRestNetworkStoreClient.getDanglingLine(networkUuid, id));
    }
    ...
    public List<Resource<ConfiguredBusAttributes>> getConfiguredBuses(UUID networkUuid) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getAllResources(ResourceType.CONFIGURED_BUS, () -> bufferedRestNetworkStoreClient.getConfiguredBuses(networkUuid));
    }
    ...
    public Optional<Resource<ConfiguredBusAttributes>> getConfiguredBus(UUID networkUuid, String busId) {
        return networksCache.computeIfAbsent(networkUuid, k -> new NetworkCache(k)).getResource(ResourceType.CONFIGURED_BUS, busId, id ->  bufferedRestNetworkStoreClient.getConfiguredBus(networkUuid, id));
    }
