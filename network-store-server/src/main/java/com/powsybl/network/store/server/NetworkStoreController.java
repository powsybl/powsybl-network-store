...
public class NetworkStoreController {
    ...
    @ApiOperation(value = "Get network list (only initial variant)", response = TopLevelDocument.class)
    ...
    @ApiOperation(value = "Get networks by id", response = TopLevelDocument.class)
    @ApiResponses(value = @ApiResponse(code = 200, message = "Successfully get network"))
    public ResponseEntity<TopLevelDocument<NetworkAttributes>> getNetworks(@ApiParam(value = "Network ID", required = true) @PathVariable("networkId") UUID id,
                                                                           @ApiParam(value = "Max number of network to get") @RequestParam(required = false) Integer limit) {
    ...
    @ApiOperation(value = "Delete a network by id (only one variant)")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Successfully delete network variant"),
            @ApiResponse(code = 404, message = "Network has not been found")
    })
    public ResponseEntity<Void> deleteNetwork(@ApiParam(value = "Network ID", required = true) @PathVariable("networkId") UUID id,
                                              @ApiParam(value = "Variant number", required = true) @PathVariable("variantNum") int variantNum) {
