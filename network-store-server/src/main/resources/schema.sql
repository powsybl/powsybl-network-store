...
CREATE TABLE IF NOT EXISTS twoWindingsTransformer (
    ...
    currentPermanentLimit1 double precision,
    currentPermanentLimit2 double precision,
    activePowerPermanentLimit1 double precision,
    activePowerPermanentLimit2 double precision,
    apparentPowerPermanentLimit1 double precision,
    apparentPowerPermanentLimit2 double precision,
...
CREATE TABLE IF NOT EXISTS threeWindingsTransformer (
    ...
    currentPermanentLimit1 double precision,
    currentPermanentLimit2 double precision,
    currentPermanentLimit3 double precision,
    activePowerPermanentLimit1 double precision,
    activePowerPermanentLimit2 double precision,
    activePowerPermanentLimit3 double precision,
    apparentPowerPermanentLimit1 double precision,
    apparentPowerPermanentLimit2 double precision,
    apparentPowerPermanentLimit3 double precision,
    bus1 VARCHAR(255),
    connectableBus1 VARCHAR(255),
    bus2 VARCHAR(255),
    connectableBus2 VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS danglingLine (
    ...
    currentPermanentLimit double precision,
    activePowerPermanentLimit double precision,
    apparentPowerPermanentLimit double precision,
    p double precision,
    q double precision,
    position text,
    bus VARCHAR(255),
