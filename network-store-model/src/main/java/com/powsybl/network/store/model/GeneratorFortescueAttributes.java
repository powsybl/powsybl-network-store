...
@AllArgsConstructor
@Builder
@Schema(description = "Generator Fortescue Attributes")
public class GeneratorFortescueAttributes implements ExtensionAttributes {
    ...
    @Schema(description = "xn")
    private double xn;

    @Schema(description = "grounded")
