...
public class TwoWindingsTransformerAttributes extends AbstractIdentifiableAttributes implements BranchAttributes, TapChangerParentAttributes, TransformerAttributes {
    ...
    public Attributes filter(AttributeFilter filter) {
        ...
        return new TwoWindingsTransformerSvAttributes(getP1(), getQ1(), getP2(), getQ2(),
                getPhaseTapChangerAttributes() != null ? getPhaseTapChangerAttributes().getTapPosition() : null,
                getRatioTapChangerAttributes() != null ? getRatioTapChangerAttributes().getTapPosition() : null);
    }
}
