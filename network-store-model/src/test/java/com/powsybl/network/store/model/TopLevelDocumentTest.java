...
public class TopLevelDocumentTest {
    ...
    public void test() throws IOException {
        ...
        String jsonRef = "{\"data\":[{\"type\":\"SUBSTATION\",\"id\":\"S\",\"variantNum\":0,\"attributes\":{\"fictitious\":false,\"country\":\"FR\",\"extensionAttributes\":{}}}],\"meta\":{}}";
    ...
    public void testMultiResources() throws IOException {
        ...
        ObjectMapper objectMapper = JsonUtil.createObjectMapper();
        String json = objectMapper.writeValueAsString(document);
        String jsonRef = "{\"data\":[{\"type\":\"SUBSTATION\",\"id\":\"S\",\"variantNum\":0,\"attributes\":{\"fictitious\":false,\"country\":\"FR\",\"extensionAttributes\":{}}},{\"type\":\"SUBSTATION\",\"id\":\"S\",\"variantNum\":0,\"attributes\":{\"fictitious\":false,\"country\":\"FR\",\"extensionAttributes\":{}}}],\"meta\":{}}";
        assertEquals(jsonRef, json);
        TopLevelDocument document2 = objectMapper.readValue(json, TopLevelDocument.class);
