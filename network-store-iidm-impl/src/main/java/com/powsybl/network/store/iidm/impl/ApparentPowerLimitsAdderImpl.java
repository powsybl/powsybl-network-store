 ...
 */
public class ApparentPowerLimitsAdderImpl<S, OWNER extends LimitsOwner<S>>
        extends AbstractLoadingLimitsAdderImpl<S, OWNER, ApparentPowerLimits, ApparentPowerLimitsAdder>
