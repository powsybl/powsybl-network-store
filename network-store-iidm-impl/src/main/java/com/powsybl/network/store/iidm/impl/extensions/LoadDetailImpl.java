...
public class LoadDetailImpl extends AbstractExtension<Load> implements LoadDetail {
    ...
    public LoadDetail setFixedActivePower(double fixedActivePower) {
        ...
        if (oldValue != fixedActivePower) {
            getLoad().updateResourceExtension(this, res -> res.getAttributes().getLoadDetail().setFixedActivePower(checkPower(fixedActivePower, "Invalid fixedActivePower", getLoad())),
                    "fixedActivePower", oldValue, fixedActivePower);
        }
        return this;
    }
    ...
    public LoadDetail setFixedReactivePower(double fixedReactivePower) {
        ...
        if (oldValue != fixedReactivePower) {
            getLoad().updateResourceExtension(this, res -> res.getAttributes().getLoadDetail().setFixedReactivePower(checkPower(fixedReactivePower, "Invalid fixedReactivePower", getLoad())),
                    "fixedReactivePower", oldValue, fixedReactivePower);
        }
        return this;
    }
    ...
    public LoadDetail setVariableActivePower(double variableActivePower) {
        ...
        if (oldValue != variableActivePower) {
            getLoad().updateResourceExtension(this, res -> res.getAttributes().getLoadDetail().setVariableActivePower(checkPower(variableActivePower, "Invalid variableActivePower", getLoad())),
                    "variableActivePower", oldValue, variableActivePower);
        }
        return this;
    }
    ...
    public LoadDetail setVariableReactivePower(double variableReactivePower) {
        ...
        if (oldValue != variableReactivePower) {
            getLoad().updateResourceExtension(this, res -> res.getAttributes().getLoadDetail().setVariableReactivePower(checkPower(variableReactivePower, "Invalid variableReactivePower", getLoad())),
                    "variableReactivePower", oldValue, variableReactivePower);
        }
        return this;
    }
