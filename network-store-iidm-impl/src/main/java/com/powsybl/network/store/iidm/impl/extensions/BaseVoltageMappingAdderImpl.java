...
public class BaseVoltageMappingAdderImpl extends AbstractIidmExtensionAdder<Network, BaseVoltageMapping> implements BaseVoltageMappingAdder {
    ...
    protected BaseVoltageMapping createExtension(Network network) {
        ((NetworkImpl) network).updateResourceWithoutNotification(res -> res.getAttributes().setBaseVoltageMapping(new BaseVoltageMappingAttributes(baseVoltageSourceAttributeMap)));
