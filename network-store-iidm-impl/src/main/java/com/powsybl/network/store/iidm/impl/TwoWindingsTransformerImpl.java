...
public class TwoWindingsTransformerImpl extends AbstractBranchImpl<TwoWindingsTransformer, TwoWindingsTransformerAttributes> implements TwoWindingsTransformer, TapChangerParent {
    ...
    public void setPhaseTapChanger(PhaseTapChangerAttributes attributes) {
        ...
        updateResource(res -> res.getAttributes().setPhaseTapChangerAttributes(attributes), AttributeFilter.WITHOUT_LIMITS,
    ...
    public void setRatioTapChanger(RatioTapChangerAttributes attributes) {
        ...
        updateResource(res -> res.getAttributes().setRatioTapChangerAttributes(attributes), AttributeFilter.WITHOUT_LIMITS,
    ...
    public TwoWindingsTransformer setG(double g) {
        ...
        if (g != oldValue) {
            updateResource(res -> res.getAttributes().setG(g), AttributeFilter.WITHOUT_LIMITS,
                "g", oldValue, g);
        }
        return this;
    }
    ...
    public TwoWindingsTransformer setB(double b) {
        ...
        if (b != oldValue) {
            updateResource(res -> res.getAttributes().setB(b), AttributeFilter.WITHOUT_LIMITS,
                "b", oldValue, b);
        }
        return this;
    }
    ...
    public TwoWindingsTransformer setRatedU1(double ratedU1) {
        ...
        if (ratedU1 != oldValue) {
            updateResource(res -> res.getAttributes().setRatedU1(ratedU1), AttributeFilter.WITHOUT_LIMITS,
    ...
    public TwoWindingsTransformer setRatedU2(double ratedU2) {
        ...
        if (ratedU2 != oldValue) {
            updateResource(res -> res.getAttributes().setRatedU2(ratedU2), AttributeFilter.WITHOUT_LIMITS,
    ...
    public TwoWindingsTransformer setRatedS(double ratedS) {
        ...
        if (Double.compare(ratedS, oldValue) != 0) {
            updateResource(res -> res.getAttributes().setRatedS(ratedS), AttributeFilter.WITHOUT_LIMITS,
