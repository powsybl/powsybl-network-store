...
public class NetworkObjectIndex {
    ...
    Optional<SubstationImpl> getSubstation(String id) {
        return getOne(id, substationById,
            () -> storeClient.getSubstation(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, id),
            resource -> SubstationImpl.create(this, resource));
    }

    List<Substation> getSubstations() {
        return getAll(substationById,
            () -> storeClient.getSubstations(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM),
            resource -> SubstationImpl.create(this, resource));
    }
    ...
    public void removeSubstation(String substationId) {
        storeClient.removeSubstations(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, Collections.singletonList(substationId));
    ...
    Optional<VoltageLevelImpl> getVoltageLevel(String id) {
        return getOne(id, voltageLevelById,
            () -> storeClient.getVoltageLevel(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, id),
            resource -> VoltageLevelImpl.create(this, resource));
    }

    List<VoltageLevel> getVoltageLevels() {
        return getAll(voltageLevelById,
            () -> storeClient.getVoltageLevels(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM),
            resource -> VoltageLevelImpl.create(this, resource));
    }

    List<VoltageLevel> getVoltageLevels(String substationId) {
        return getSome(voltageLevelById,
            () -> storeClient.getVoltageLevelsInSubstation(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, substationId),
            resource -> VoltageLevelImpl.create(this, resource));
    }
    ...
    public void removeVoltageLevel(String voltageLevelId) {
        storeClient.removeVoltageLevels(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, Collections.singletonList(voltageLevelId));
    ...
    Optional<GeneratorImpl> getGenerator(String id) {
        return getOne(id, generatorById,
            () -> storeClient.getGenerator(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, id),
            resource -> GeneratorImpl.create(this, resource));
    }

    List<Generator> getGenerators() {
        return getAll(generatorById,
            () -> storeClient.getGenerators(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM),
            resource -> GeneratorImpl.create(this, resource));
    }

    List<Generator> getGenerators(String voltageLevelId) {
        return getSome(generatorById,
            () -> storeClient.getVoltageLevelGenerators(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, voltageLevelId),
            resource -> GeneratorImpl.create(this, resource));
    }
    ...
    public void removeGenerator(String generatorId) {
        storeClient.removeGenerators(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, Collections.singletonList(generatorId));
    ...
    Optional<BatteryImpl> getBattery(String id) {
        return getOne(id, batteryById,
            () -> storeClient.getBattery(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, id),
            resource -> BatteryImpl.create(this, resource));
    }

    List<Battery> getBatteries() {
        return getAll(batteryById,
            () -> storeClient.getBatteries(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM),
            resource -> BatteryImpl.create(this, resource));
    }

    List<Battery> getBatteries(String voltageLevelId) {
        return getSome(batteryById,
            () -> storeClient.getVoltageLevelBatteries(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, voltageLevelId),
            resource -> BatteryImpl.create(this, resource));
    }
    ...
    public void removeBattery(String batteryId) {
        storeClient.removeBatteries(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, Collections.singletonList(batteryId));
    ...
    Optional<LoadImpl> getLoad(String id) {
        return getOne(id, loadById,
            () -> storeClient.getLoad(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, id),
            resource -> LoadImpl.create(this, resource));
    }

    List<Load> getLoads() {
        return getAll(loadById,
            () -> storeClient.getLoads(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM),
            resource -> LoadImpl.create(this, resource));
    }

    List<Load> getLoads(String voltageLevelId) {
        return getSome(loadById,
            () -> storeClient.getVoltageLevelLoads(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, voltageLevelId),
            resource -> LoadImpl.create(this, resource));
    }
    ...
    public void removeLoad(String loadId) {
        storeClient.removeLoads(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, Collections.singletonList(loadId));
    ...
    Optional<BusbarSectionImpl> getBusbarSection(String id) {
        return getOne(id, busbarSectionById,
            () -> storeClient.getBusbarSection(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, id),
            resource -> BusbarSectionImpl.create(this, resource));
    }

    List<BusbarSection> getBusbarSections() {
        return getAll(busbarSectionById,
            () -> storeClient.getBusbarSections(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM),
            resource -> BusbarSectionImpl.create(this, resource));
    }

    List<BusbarSection> getBusbarSections(String voltageLevelId) {
        return getSome(busbarSectionById,
            () -> storeClient.getVoltageLevelBusbarSections(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, voltageLevelId),
            resource -> BusbarSectionImpl.create(this, resource));
    }
    ...
    public void removeBusBarSection(String busBarSectionId) {
        storeClient.removeBusBarSections(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, Collections.singletonList(busBarSectionId));
    ...
    Optional<SwitchImpl> getSwitch(String id) {
        return getOne(id, switchById,
            () -> storeClient.getSwitch(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, id),
            resource -> SwitchImpl.create(this, resource));
    }

    List<Switch> getSwitches() {
        return getAll(switchById,
            () -> storeClient.getSwitches(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM),
            resource -> SwitchImpl.create(this, resource));
    }

    List<Switch> getSwitches(String voltageLevelId) {
        return getSome(switchById,
            () -> storeClient.getVoltageLevelSwitches(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, voltageLevelId),
            resource -> SwitchImpl.create(this, resource));
    }
    ...
    public void removeSwitch(String switchId) {
        storeClient.removeSwitches(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, Collections.singletonList(switchId));
    ...
    Optional<TwoWindingsTransformerImpl> getTwoWindingsTransformer(String id) {
        return getOne(id, twoWindingsTransformerById,
            () -> storeClient.getTwoWindingsTransformer(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, id),
    ...
    List<TwoWindingsTransformer> getTwoWindingsTransformers() {
        return getAll(twoWindingsTransformerById,
            () -> storeClient.getTwoWindingsTransformers(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM),
            resource -> TwoWindingsTransformerImpl.create(this, resource));
    }

    List<TwoWindingsTransformer> getTwoWindingsTransformers(String voltageLevelId) {
        return getSome(twoWindingsTransformerById,
            () -> storeClient.getVoltageLevelTwoWindingsTransformers(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, voltageLevelId),
            resource -> TwoWindingsTransformerImpl.create(this, resource));
    }
    ...
    public void removeTwoWindingsTransformer(String twoWindingsTransformerId) {
        storeClient.removeTwoWindingsTransformers(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, Collections.singletonList(twoWindingsTransformerId));
    ...
    Optional<ThreeWindingsTransformerImpl> getThreeWindingsTransformer(String id) {
        return getOne(id, threeWindingsTransformerById,
            () -> storeClient.getThreeWindingsTransformer(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, id),
    ...
    List<ThreeWindingsTransformer> getThreeWindingsTransformers() {
        return getAll(threeWindingsTransformerById,
            () -> storeClient.getThreeWindingsTransformers(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM),
            resource -> ThreeWindingsTransformerImpl.create(this, resource));
    }
    ...
    List<ThreeWindingsTransformer> getThreeWindingsTransformers(String voltageLevelId) {
        return getSome(threeWindingsTransformerById,
            () -> storeClient.getVoltageLevelThreeWindingsTransformers(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, voltageLevelId),
            resource -> ThreeWindingsTransformerImpl.create(this, resource));
    }
    ...
    public void removeThreeWindingsTransformer(String threeWindingsTransformerId) {
        storeClient.removeThreeWindingsTransformers(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, Collections.singletonList(threeWindingsTransformerId));
    ...
    Optional<Line> getLine(String id) {
        return getOne(id, lineById,
            () -> storeClient.getLine(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, id),
            this::createLineOrTieLine);
    }

    List<Line> getLines() {
        return getAll(lineById,
            () -> storeClient.getLines(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM),
            this::createLineOrTieLine);
    }

    List<Line> getLines(String voltageLevelId) {
        return getSome(lineById,
            () -> storeClient.getVoltageLevelLines(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, voltageLevelId),
            this::createLineOrTieLine);
    }
    ...
    public void removeLine(String lineId) {
        storeClient.removeLines(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, Collections.singletonList(lineId));
    ...
    Optional<ShuntCompensatorImpl> getShuntCompensator(String id) {
        return getOne(id, shuntCompensatorById,
            () -> storeClient.getShuntCompensator(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, id),
    ...
    List<ShuntCompensator> getShuntCompensators() {
        return getAll(shuntCompensatorById,
            () -> storeClient.getShuntCompensators(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM),
            resource -> ShuntCompensatorImpl.create(this, resource));
    }

    List<ShuntCompensator> getShuntCompensators(String voltageLevelId) {
        return getSome(shuntCompensatorById,
            () -> storeClient.getVoltageLevelShuntCompensators(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, voltageLevelId),
            resource -> ShuntCompensatorImpl.create(this, resource));
    }
    ...
    public void removeShuntCompensator(String shuntCompensatorId) {
        storeClient.removeShuntCompensators(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, Collections.singletonList(shuntCompensatorId));
    ...
    Optional<VscConverterStationImpl> getVscConverterStation(String id) {
        return getOne(id, vscConverterStationById,
            () -> storeClient.getVscConverterStation(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, id),
    ...
    List<VscConverterStation> getVscConverterStations() {
        return getAll(vscConverterStationById,
            () -> storeClient.getVscConverterStations(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM),
            resource -> VscConverterStationImpl.create(this, resource));
    }

    List<VscConverterStation> getVscConverterStations(String voltageLevelId) {
        return getSome(vscConverterStationById,
            () -> storeClient.getVoltageLevelVscConverterStations(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, voltageLevelId),
            resource -> VscConverterStationImpl.create(this, resource));
    }
    ...
    public void removeVscConverterStation(String vscConverterStationId) {
        storeClient.removeVscConverterStations(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, Collections.singletonList(vscConverterStationId));
    ...
    Optional<LccConverterStationImpl> getLccConverterStation(String id) {
        return getOne(id, lccConverterStationById,
            () -> storeClient.getLccConverterStation(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, id),
    ...
    List<LccConverterStation> getLccConverterStations() {
        return getAll(lccConverterStationById,
            () -> storeClient.getLccConverterStations(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM),
            resource -> LccConverterStationImpl.create(this, resource));
    }

    List<LccConverterStation> getLccConverterStations(String voltageLevelId) {
        return getSome(lccConverterStationById,
            () -> storeClient.getVoltageLevelLccConverterStations(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, voltageLevelId),
            resource -> LccConverterStationImpl.create(this, resource));
    }
    ...
    public void removeLccConverterStation(String lccConverterStationId) {
        storeClient.removeLccConverterStations(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, Collections.singletonList(lccConverterStationId));
    ...
    Optional<StaticVarCompensatorImpl> getStaticVarCompensator(String id) {
        return getOne(id, staticVarCompensatorById,
            () -> storeClient.getStaticVarCompensator(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, id),
    ...
    List<StaticVarCompensator> getStaticVarCompensators() {
        return getAll(staticVarCompensatorById,
            () -> storeClient.getStaticVarCompensators(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM),
            resource -> StaticVarCompensatorImpl.create(this, resource));
    }

    List<StaticVarCompensator> getStaticVarCompensators(String voltageLevelId) {
        return getSome(staticVarCompensatorById,
            () -> storeClient.getVoltageLevelStaticVarCompensators(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, voltageLevelId),
            resource -> StaticVarCompensatorImpl.create(this, resource));
    }
    ...
    public void removeStaticVarCompensator(String staticVarCompensatorId) {
        storeClient.removeStaticVarCompensators(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, Collections.singletonList(staticVarCompensatorId));
    ...
    Optional<HvdcLineImpl> getHvdcLine(String id) {
        return getOne(id, hvdcLineById,
            () -> storeClient.getHvdcLine(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, id),
            resource -> HvdcLineImpl.create(this, resource));
    }

    List<HvdcLine> getHvdcLines() {
        return getAll(hvdcLineById,
            () -> storeClient.getHvdcLines(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM),
            resource -> HvdcLineImpl.create(this, resource));
    }
    ...
    public void removeHvdcLine(String hvdcLineId) {
        storeClient.removeHvdcLines(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, Collections.singletonList(hvdcLineId));
    ...
    Optional<DanglingLineImpl> getDanglingLine(String id) {
        return getOne(id, danglingLineById,
            () -> storeClient.getDanglingLine(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, id),
            resource -> DanglingLineImpl.create(this, resource));
    }

    List<DanglingLine> getDanglingLines() {
        return getAll(danglingLineById,
            () -> storeClient.getDanglingLines(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM),
            resource -> DanglingLineImpl.create(this, resource));
    }

    List<DanglingLine> getDanglingLines(String voltageLevelId) {
        return getSome(danglingLineById,
            () -> storeClient.getVoltageLevelDanglingLines(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, voltageLevelId),
            resource -> DanglingLineImpl.create(this, resource));
    }
    ...
    public void removeDanglingLine(String danglingLineId) {
        storeClient.removeDanglingLines(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, Collections.singletonList(danglingLineId));
    ...
    Optional<Bus> getBus(String id) {
        return getOne(id, busesById,
            () -> storeClient.getConfiguredBus(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, id),
            resource -> ConfiguredBusImpl.create(this, resource));
    }

    List<Bus> getBuses() {
        return getAll(busesById,
            () -> storeClient.getConfiguredBuses(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM),
            resource -> ConfiguredBusImpl.create(this, resource));
    }

    List<Bus> getBuses(String voltageLevelId) {
        return getSome(busesById,
            () -> storeClient.getVoltageLevelConfiguredBuses(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, voltageLevelId),
            resource -> ConfiguredBusImpl.create(this, resource));
    }
    ...
    public void removeBus(String busId) {
        storeClient.removeConfiguredBuses(network.getUuid(), VariantManagerImpl.INITIAL_VARIANT_NUM, Collections.singletonList(busId));
